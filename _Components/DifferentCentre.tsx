...
function DifferentCentre() {
  return (
    ...
    <div className='bg-green-900'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-8  max-w-7xl m-auto rounded-xl  text-white'>
        <div className='border border-white/16 shadow-2xl mt-10 p-6 m-3 md:p-10 rounded-xl space-y-5'>
        ...
        <div className='border border-white/25 shadow-2xl mt-10 p-6  m-3 md:p-10 rounded-xl space-y-5'>
