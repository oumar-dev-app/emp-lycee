                            ...
                            <div className="bg-white/90 w-full h-full">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className='text-white bg-gray-500 shadow-2xl p-6 md:p-10 rounded-xl space-y-5'>
                                        ...
                                        <p className='flex items-center gap-4'> <FaCheck className="text-yellow-500 shrink-0" />DEF 2021 : plusieurs élèves classés parmi les meilleurs</p>
                                        <p className='flex items-center gap-4'> <FaCheck className="text-yellow-500 shrink-0" /> DEF 2022 : 95%</p>
                                        <p className='flex items-center gap-4'> <FaCheck className="text-yellow-500 shrink-0" />DEF 2022 : 95%</p>
                                    ...
                                    <div className='text-white bg-gray-500 shadow-2xl p-2 md:p-10 rounded-xl space-y-5'>
                                    ...
                                    <div className='text-white bg-gray-500 shadow-2xl p-6 md:p-10 rounded-xl space-y-5'>
                                        ...
                                        <p className='flex items-center gap-4'> <FaCheck className="text-yellow-500 shrink-0" /> Olympiades 2025 : 1ère et 2ème places académiques</p>
                                    </div>
                                </div>
                            </div>
